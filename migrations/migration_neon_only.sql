-- ============================================================================
-- MIGRATION v2.0: Solo cambios a base de datos existente
-- ============================================================================

-- Crear tabla de Historial de Cambios de Grupo (nueva)
...
-- Crear índices para historial si no existen
CREATE INDEX IF NOT EXISTS ix_historial_cambio_grupo_activo_id ON historial_cambio_grupo(activo_id);
CREATE INDEX IF NOT EXISTS ix_historial_cambio_grupo_fecha ON historial_cambio_grupo(fecha_cambio);

-- Actualizar tabla registros_inventario (eliminar campos obsoletos)
